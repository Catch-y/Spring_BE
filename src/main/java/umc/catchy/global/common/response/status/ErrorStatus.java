...
public enum ErrorStatus implements BaseErrorCode {
    ...
    BLACKLISTED_TOKEN(HttpStatus.UNAUTHORIZED, "BLACKLIST_TOKEN401", "만료된 액세스토큰 입니다."),
    TOKEN_STORAGE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "TOKEN_STORAGE400", "토큰 저장에 실패했습니다."),
