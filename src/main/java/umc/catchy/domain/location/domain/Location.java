...
public class Location extends BaseTimeEntity {
    ...
    public static Location createLocation(String upperLocation, String lowerLocation) {
        return Location.builder()
                .upperLocation(LocationUtils.normalizeLocation(upperLocation))
    ...
    @PrePersist
    @PreUpdate
    public void normalizeUpperLocation() {
        this.upperLocation = LocationUtils.normalizeLocation(this.upperLocation);
    }
}
