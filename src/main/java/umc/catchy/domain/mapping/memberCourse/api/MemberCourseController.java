...
public class MemberCourseController {
    ...
    public ResponseEntity<BaseResponse<SliceResponse<MemberCourseResponse>>> getMemberCourses(
        ...
        SliceResponse<MemberCourseResponse> response = memberCourseService.getMemberCourses(type, upperLocation, lowerLocation, lastId);
    ...
    public BaseResponse<SliceResponse<MemberCourseResponse>> findAllCourseByBookmarked(
            @RequestParam int pageSize,
            @RequestParam(required = false) Long lastCourseId
    ) {
        SliceResponse<MemberCourseResponse> response = memberCourseService.findAllCourseByBookmarked(pageSize, lastCourseId);
