...
public class MemberController {
    ...
    public BaseResponse<SignUpResponse> signUp(@Parameter(
            ...
            required = true,
            in = ParameterIn.PATH
    )@PathVariable("platform") String platform, @RequestPart("info") SignUpRequest info, @RequestPart("profileImage") MultipartFile profileImage) {
        ...
        try {
            ...
            throw new GeneralException(ErrorStatus.PLATFORM_BAD_REQUEST);
        }


        return BaseResponse.onSuccess(SuccessStatus._CREATED, memberService.signUp(info, profileImage, socialType));
    }
